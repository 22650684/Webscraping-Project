...
for i in parentDivs:
    ...
    response_checker = str(i.h2)
    response_ptag = i.find("p", class_="margin-top-1 margin-bottom-0")
    ...
    if "STORY HAS A RESPONSE" in response_checker:
        responseStr = response_ptag.text 
...
response = open("responseStage"+id, "w+")
