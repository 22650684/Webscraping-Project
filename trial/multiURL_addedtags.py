...
for num in range(10,40):
    ...
    for i in parentDivs:
        ...
        responseStage_checker = str(i.h2)
        response_tag = i.find("p", class_="inline-block font-c-1 tooltip")
        ...
        if "STORY HAS A RESPONSE" in responseStage_checker:
            responseStage.append(tag.text)
